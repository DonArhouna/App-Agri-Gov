...
function AvatarComponent_ProjectionFallback_0_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngSrc", (tmp_3_0 = ctx_r0.src()) !== null && tmp_3_0 !== void 0 ? tmp_3_0 : "");
  }
}
function AvatarComponent_ProjectionFallback_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, AvatarComponent_ProjectionFallback_0_Conditional_0_Template, 1, 2, "img", 1);
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
...
_AvatarComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 3,
  vars: 1,
  consts: [[3, "ngClass"], ["fill", "", 1, "avatar-img", 3, "ngSrc", "alt"]],
  ...
  dependencies: [NgClass, NgOptimizedImage],
  encapsulation: 2
});
